...
fn bindgen_test_layout_TEEC_Context() {
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<TEEC_Context>())).memref_null as *const _ as usize },
        5usize,
        concat!(
            "Offset of field: ",
            stringify!(TEEC_Context),
            "::",
            stringify!(memref_null)
        )
    );
}
...
pub struct TEEC_SharedMemory {
    ...
    pub shadow_buffer: *mut libc::c_void,
    pub registered_fd: libc::c_int,
    pub internal: TEEC_SharedMemory__bindgen_ty_1,
}
#[repr(C)]
#[derive(Copy, Clone)]
...
fn bindgen_test_layout_TEEC_SharedMemory__bindgen_ty_1() {
    assert_eq!(
        ::core::mem::size_of::<TEEC_SharedMemory__bindgen_ty_1>(),
        1usize,
        concat!("Size of: ", stringify!(TEEC_SharedMemory__bindgen_ty_1))
    );
    assert_eq!(
        ::core::mem::align_of::<TEEC_SharedMemory__bindgen_ty_1>(),
        1usize,
        concat!("Alignment of ", stringify!(TEEC_SharedMemory__bindgen_ty_1))
    );
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<TEEC_SharedMemory__bindgen_ty_1>())).dummy as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(TEEC_SharedMemory__bindgen_ty_1),
            "::",
            stringify!(dummy)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<TEEC_SharedMemory__bindgen_ty_1>())).flags as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
...
impl Default for TEEC_SharedMemory__bindgen_ty_1 {
    fn default() -> Self {
...
fn bindgen_test_layout_TEEC_SharedMemory() {
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<TEEC_SharedMemory>())).internal as *const _ as usize },
        44usize,
        concat!(
            "Offset of field: ",
            stringify!(TEEC_SharedMemory),
...
extern "C" {
    ...
    pub fn TEEC_OpenSession(
        ...
        connectionData: *const libc::c_void,
